...
router.post("/send-password-reset-link", dynamicPublicLimiter, userController.sendPasswordResetLink);
router.post("/reset-password-with-verification", dynamicPublicLimiter, userController.resetPasswordWithVerification);
router.post("/reset-password-with-token", dynamicPublicLimiter, userController.resetPasswordWithToken);
